...
print_org_doc(documented_items,link_prefix="All_", header_level=0)
  ...
  <<9Ow5qI7P>> *Index:* *[A]* [[JkvNa4uM][AArray]], [[A6Mtt6FX][AFloat]], [[jzHhVlhZ][AFloat32]], [[eANBWUta][AFloat64]] *[B]* [[RsI9bA23][Base.push!]], [[eZSWPCzi][Base.show]] *[I]* [[rdNLJwfS][IndexStyle]] *[T]* [[nforrZNo][Tape]] *[a]* [[VePN6Bg3][afloat_count]], [[jTT3Fkot][afloat_next_index]], [[Uyj5wvKK][aidx]], [[5yIhe8sD][aidx_type]] *[c]* [[VQrwEkoL][create_tape_chunk]], [[Ilv9IOhf][create_tape_record]] *[e]* [[0Ri1T5Vi][export]] *[f]* [[v0eyqc3t][f_gradient]] *[g]* [[xOOq2LrU][getindex]] *[i]* [[9uSj0lhj][increase_size!]] *[p]* [[2SSVWTwN][parent]], [[puV9jHT8][parent_type]] *[r]* [[OfnmtUrZ][rewind_tape!]] *[s]* [[X37WsaJW][size]] *[t]* [[mbnfZw3P][tape_position]] *[∂]* [[1TOTLrXq][∂_j]] 
  - @@latex:\phantomsection@@ *=AArray=*  <<JkvNa4uM>> <<All_AArray>>
  #+BEGIN_SRC julia :eval never :exports code
  struct AArray{AT<:AFloat,N,P<:AbstractArray,AIDX}  <: AbstractArray{AT,N}
  #+END_SRC
  #+BEGIN_QUOTE
  ...
  *Design*:
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/array.jl::6][array.jl:6]], [[9Ow5qI7P][back to index]]
  ...
  2×3 PragmaticAD.AArray{PragmaticAD.AFloat{Float64},2,Array{Float64,2},Array{Int64,2}}:
   0.185468_55  0.698521_57  0.396057_59
   0.520399_56  0.590056_58  0.862143_60
  #+END_SRC

  *Design*:
  - [[id:b384f347-8c27-42ae-9759-2914d67cad4d][Restricted set of constructors]]
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/array.jl::25][array.jl:25]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=AFloat=*  <<A6Mtt6FX>> <<All_AFloat>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/afloat.jl::4][afloat.jl:4]], [[9Ow5qI7P][back to index]]
  ...
  #+END_SRC
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/afloat.jl::14][afloat.jl:14]], [[9Ow5qI7P][back to index]]

  #+BEGIN_SRC julia :eval never :exports code
  AFloat(value::T) where {T<:AbstractFloat}
  #+END_SRC
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/afloat.jl::21][afloat.jl:21]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=AFloat32=*  <<jzHhVlhZ>>
  #+BEGIN_SRC julia :eval never :exports code
  const AFloat32
  #+END_SRC
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/global.jl::5][global.jl:5]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=AFloat64=*  <<eANBWUta>>
  #+BEGIN_SRC julia :eval never :exports code
  const AFloat64
  #+END_SRC
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/global.jl::9][global.jl:9]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=Base.push!=*  <<RsI9bA23>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::57][tape.jl:57]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=Base.show=*  <<eZSWPCzi>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/afloat.jl::24][afloat.jl:24]], [[9Ow5qI7P][back to index]]

  #+BEGIN_SRC julia :eval never :exports code
  Base.show(io::IO, x::∂_j)
  #+END_SRC
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::11][tape.jl:11]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=IndexStyle=*  <<rdNLJwfS>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  *Design*:
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/array.jl::120][array.jl:120]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=Tape=*  <<nforrZNo>> <<All_Tape>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  *Note:* we use =mutable= to have a "by reference" semantic to avoid
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::15][tape.jl:15]], [[9Ow5qI7P][back to index]]
  ...
  #+END_SRC
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::28][tape.jl:28]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=afloat_count=*  <<VePN6Bg3>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::51][tape.jl:51]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=afloat_next_index=*  <<jTT3Fkot>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::44][tape.jl:44]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=aidx=*  <<Uyj5wvKK>>
  #+BEGIN_SRC julia :eval never :exports code
  aidx(aa::AArray)
  #+END_SRC
  #+BEGIN_QUOTE
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/array.jl::86][array.jl:86]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=aidx_type=*  <<5yIhe8sD>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  See [[id:c39435d9-532c-4390-8089-bde4c5e53f3e][Multiple parameters in the struct definition]]
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/array.jl::78][array.jl:78]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=create_tape_chunk=*  <<VQrwEkoL>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/array.jl::58][array.jl:58]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=create_tape_record=*  <<Ilv9IOhf>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::70][tape.jl:70]], [[9Ow5qI7P][back to index]]
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::83][tape.jl:83]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=export=*  <<0Ri1T5Vi>>
  #+BEGIN_SRC julia :eval never :exports code
  export AFloat
  #+END_SRC
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/afloat.jl::1][afloat.jl:1]], [[9Ow5qI7P][back to index]]

  #+BEGIN_SRC julia :eval never :exports code
  export afloat_count
  #+END_SRC
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::1][tape.jl:1]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=f_gradient=*  <<v0eyqc3t>> <<All_tape_f_gradient>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::120][tape.jl:120]], [[9Ow5qI7P][back to index]]
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/wrapper.jl::1][wrapper.jl:1]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=getindex=*  <<xOOq2LrU>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  *Design*:
  - [[id:1b16ffef-47fa-473c-b033-de4a864dcaf3][Interface, main methods to redefine]]
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/array.jl::127][array.jl:127]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=increase_size!=*  <<9uSj0lhj>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  the initial size
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/array.jl::47][array.jl:47]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=parent=*  <<2SSVWTwN>>
  #+BEGIN_SRC julia :eval never :exports code
  parent(aa::AArray)
  #+END_SRC
  #+BEGIN_QUOTE
  ...
  See [[id:c39435d9-532c-4390-8089-bde4c5e53f3e][Multiple parameters in the struct definition]]
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/array.jl::102][array.jl:102]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=parent_type=*  <<puV9jHT8>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  See [[id:c39435d9-532c-4390-8089-bde4c5e53f3e][Multiple parameters in the struct definition]]
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/array.jl::94][array.jl:94]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=rewind_tape!=*  <<OfnmtUrZ>> <<All_rewind_tape>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::108][tape.jl:108]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=size=*  <<X37WsaJW>>
  #+BEGIN_SRC julia :eval never :exports code
  size(aa::AArray)
  #+END_SRC
  #+BEGIN_QUOTE
  *Design*:
  - [[id:1b16ffef-47fa-473c-b033-de4a864dcaf3][Interface, main methods to redefine]]
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/array.jl::113][array.jl:113]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=tape_position=*  <<mbnfZw3P>> <<All_tape_position>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::92][tape.jl:92]], [[9Ow5qI7P][back to index]]
  - @@latex:\phantomsection@@ *=∂_j=*  <<1TOTLrXq>>
  #+BEGIN_SRC julia :eval never :exports code
  struct ∂_j{T<:Real}
  #+END_SRC
  #+BEGIN_QUOTE
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::4][tape.jl:4]], [[9Ow5qI7P][back to index]]
  :END:
