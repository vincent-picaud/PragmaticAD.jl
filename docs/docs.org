...
print_org_doc(documented_items,tag="API",header_level=0)
  ...
  <<ypLba4kp>> *Index:* *[A]* [[braQY3Xn][AArray]], [[vTdBi0p3][AFloat]], [[fGrAEBH6][AFloat32]], [[cMfYQQGA][AFloat64]] *[a]* [[zorQhXjo][afloat_count]] *[e]* [[ezojlJgw][export]] *[f]* [[Wil40d89][f_∇f]] 
  - @@latex:\phantomsection@@ *=AArray=*  <<braQY3Xn>> <<lNrcGGTKAArray>>
  ...
  *Parameters*:
  ...
  - =AIDX= is an extra parameter defining how [[lNrcGGTKAFloat][struct AFloat]] indices are
  ...
  *Design*:
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/array.jl::6][array.jl:6]], [[ypLba4kp][back to index]]
  ...
  2×3 PragmaticAD.AArray{PragmaticAD.AFloat{Float64},2,Array{Float64,2},Array{Int64,2}}:
    0.59686_3  0.647957_5  0.739671_7
   0.824004_4  0.302086_6  0.359818_8
  #+END_SRC

  *Design*:
  - [[id:b384f347-8c27-42ae-9759-2914d67cad4d][Restricted set of constructors]]
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/array.jl::25][array.jl:25]], [[ypLba4kp][back to index]]
  - @@latex:\phantomsection@@ *=AFloat=*  <<vTdBi0p3>> <<lNrcGGTKAFloat>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/afloat.jl::4][afloat.jl:4]], [[ypLba4kp][back to index]]

  #+BEGIN_SRC julia :eval never :exports code
  AFloat{T}(value::S) where {T<:AbstractFloat,S<:Real}
  #+END_SRC
  #+BEGIN_QUOTE
  Creates a new [[lNrcGGTKAFloat][struct AFloat]] from its value.
  ...
  #+END_SRC
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/afloat.jl::14][afloat.jl:14]], [[ypLba4kp][back to index]]

  #+BEGIN_SRC julia :eval never :exports code
  AFloat(value::T) where {T<:AbstractFloat}
  #+END_SRC
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/afloat.jl::21][afloat.jl:21]], [[ypLba4kp][back to index]]
  - @@latex:\phantomsection@@ *=AFloat32=*  <<fGrAEBH6>>
  #+BEGIN_SRC julia :eval never :exports code
  const AFloat32
  #+END_SRC
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/global.jl::5][global.jl:5]], [[ypLba4kp][back to index]]
  - @@latex:\phantomsection@@ *=AFloat64=*  <<cMfYQQGA>>
  #+BEGIN_SRC julia :eval never :exports code
  const AFloat64
  #+END_SRC
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/global.jl::9][global.jl:9]], [[ypLba4kp][back to index]]
  - @@latex:\phantomsection@@ *=afloat_count=*  <<zorQhXjo>>
  #+BEGIN_SRC julia :eval never :exports code
  afloat_count{T}(tape::Tape{T})::Int
  #+END_SRC
  #+BEGIN_QUOTE
  Returns how many [[lNrcGGTKAFloat][struct AFloat]] are stored in the current _struct Tape_
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::51][tape.jl:51]], [[ypLba4kp][back to index]]
  - @@latex:\phantomsection@@ *=export=*  <<ezojlJgw>>
  #+BEGIN_SRC julia :eval never :exports code
  export AFloat
  #+END_SRC
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/afloat.jl::1][afloat.jl:1]], [[ypLba4kp][back to index]]

  #+BEGIN_SRC julia :eval never :exports code
  export afloat_count
  #+END_SRC
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/tape.jl::1][tape.jl:1]], [[ypLba4kp][back to index]]
  - @@latex:\phantomsection@@ *=f_∇f=*  <<Wil40d89>>
  #+BEGIN_SRC julia :eval never :exports code
  ...
  ***ERROR***  ErrorException("type Float64 has no field value")
  ...
  #+END_QUOTE
  [[file:/home/picaud/GitHub/PragmaticAD.jl/src/wrapper.jl::32][wrapper.jl:32]], [[ypLba4kp][back to index]]
  :END:
